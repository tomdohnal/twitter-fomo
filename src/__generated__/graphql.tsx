...
export type CommunityIdFragment = (
  { __typename?: 'Community' }
  & Pick<Community, '_id'>
);

export type AllCommunityIdsQueryVariables = Exact<{ [key: string]: never; }>;


export type AllCommunityIdsQuery = (
  { __typename?: 'Query' }
  & { allCommunities: (
    { __typename?: 'CommunityPage' }
    & { data: Array<Maybe<(
...
export type RecentListQueryVariables = Exact<{
  period: Period;
  communityId?: Maybe<Scalars['ID']>;
  tweetType?: Maybe<TweetType>;
  accountType?: Maybe<AccountType>;
...
export type RecentListQuery = (
  { __typename?: 'Query' }
  & { recentList?: Maybe<(
    { __typename?: 'List' }
    & Pick<List, 'tweetType' | 'accountType' | 'period'>
    & { community?: Maybe<(
      { __typename?: 'Community' }
      & Pick<Community, 'name'>
    )>, tweets: (
      ...
      & { data: Array<Maybe<(
        { __typename?: 'Tweet' }
        & Pick<Tweet, '_id' | 'accountName' | 'favoritesCount' | 'text'>
      )>> }
    ) }
  )> }
);
